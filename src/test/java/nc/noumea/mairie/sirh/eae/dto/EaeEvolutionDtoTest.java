...
public class EaeEvolutionDtoTest {
	...
	public void testConstructor() {
		...
		evolution.setCommentaireEvolution(new EaeCommentaire("nono"));
		evolution.setCommentaireEvaluateur(new EaeCommentaire("nono"));
		evolution.setCommentaireEvalue(new EaeCommentaire("nono"));
		...
		assertEquals(evolution.getCommentaireEvolution().getText(), dto.getCommentaireEvolution().getText());
		assertEquals(evolution.getCommentaireEvaluateur().getText(), dto.getCommentaireEvaluateur().getText());
		assertEquals(evolution.getCommentaireEvalue().getText(), dto.getCommentaireEvalue().getText());
	}
	...
	public void testConstructorWithLists() {
		...
		assertEquals(evolution.getEaeEvolutionSouhaits().iterator().next().getIdEaeEvolutionSouhait(), dto.getSouhaitsSuggestions().get(0).getIdEaeEvolutionSouhait());
		assertEquals(evolution.getEaeEvolutionSouhaits().iterator().next().getSouhait(), dto.getSouhaitsSuggestions().get(0).getSouhait());
		assertEquals(evolution.getEaeEvolutionSouhaits().iterator().next().getSuggestion(), dto.getSouhaitsSuggestions().get(0).getSuggestion());
		
		assertEquals(1, dto.getDeveloppementConnaissances().size());
		assertEquals(dev1.getIdEaeDeveloppement(), dto.getDeveloppementConnaissances().get(0).getIdEaeDeveloppement());
...
//		
//		dto.setCommentaireEvolution(new EaeCommentaireDto());
//		dto.getCommentaireEvolution().setText("commentaire evolution");
//		
//		dto.setCommentaireEvaluateur(new EaeCommentaireDto());
//		dto.getCommentaireEvaluateur().setText("commentaire evaluateur");
//		
//		dto.setCommentaireEvalue(new EaeCommentaireDto());
