...
public class EvaluationControllerTest {
	...
	@Test
	public void testSetEaeEvaluation_updateExistingEae_ReturnCode200() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
	...
	@Test
	public void testSetEaeEvaluation_EaeCannotBeStarted_ReturnCode409() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).clear();
	...
	@Test
	public void testSetEaeEvaluation_EvaluationDataIsInvalid_ReturnCode409() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
	...
	@Test
	public void testSetEaeAutoEvaluation_updateExistingEae_ReturnCode200() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).flush();
	...
	@Test
	public void testSetEaeAutoEvaluation_EaeCannotBeStarted_ReturnCode409() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).clear();
	...
	@Test
	public void testSetEaePlanAction_updateExistingEae_ReturnCode200() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).flush();
	...
	@Test
	public void testSetEaePlanAction_EaeCannotBeStarted_ReturnCode409() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).clear();
	...
	@Test
	public void testSetEaeEvolution_updateExistingEae_ReturnCode200() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).flush();
	...
	@Test
	public void testSetEaeEvolution_EaeCannotBeStarted_ReturnCode409() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).clear();
	...
	@Test
	public void testSetEaeEvolution_EaeEvolutionCannotBeSaved_ReturnCode409() throws EvaluationServiceException, EaeServiceException, IllegalStateException, SecurityException, SystemException {
		// Given
		// Mock the Eae find static method to return our null eae
		Eae eaeToReturn = spy(new Eae());
		Mockito.doNothing().when(eaeToReturn).clear();
		...
		IEvaluationService evaluationServiceMock = Mockito.mock(IEvaluationService.class);
		Mockito.doThrow(new EvaluationServiceException("message")).when(evaluationServiceMock).setEaeEvolution(Mockito.eq(eaeToReturn), Mockito.any(EaeEvolutionDto.class));
		IEaeService eaeServiceMock = Mockito.mock(IEaeService.class);
