...
public class CalculEaeServiceTest {
	...
	public void getDateEntreeService_returnDateServiceAnterieur_MultipleAffectation() throws ParseException, SirhWSConsumerException {
		...
		ISirhWsConsumer sirhWsConsumer = Mockito.mock(ISirhWsConsumer.class);
			Mockito.when(sirhWsConsumer.getListeAffectationsAgentAvecService(Mockito.anyInt(), Mockito.anyString())).thenReturn(listeAffectationService);
	...
	public void getDateEntreeService_returnNull() throws SirhWSConsumerException {
		...
		ISirhWsConsumer sirhWsConsumer = Mockito.mock(ISirhWsConsumer.class);
			Mockito.when(sirhWsConsumer.getListeAffectationsAgentAvecService(Mockito.anyInt(), Mockito.anyString())).thenReturn(null);
