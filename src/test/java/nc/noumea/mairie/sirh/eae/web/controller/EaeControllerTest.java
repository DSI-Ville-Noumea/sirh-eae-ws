...
public class EaeControllerTest {
	...
	@Test
	public void testStartEae_EaeForAgentCannotBeStarted_ReturnHttp409() throws EaeServiceException {
		...
		org.mockito.Mockito.doThrow(ex).when(eaeServiceMock).startEae(lastEae);
		...
		// When
		ResponseEntity<String> result = controller.startEae(agentId, agentEvalueId);
	...
	@Test
	public void testStartEae_EaeForAgentCanBeStarted_ReturnHttp200() throws EaeServiceException {
		...
		verify(eaeServiceMock, times(1)).startEae(lastEae);
	}
	
	@Test
	public void testStartEae_EaeForAgentCantBeFound_ReturnHttp404() throws EaeServiceException {
		...
		verify(eaeServiceMock, times(0)).startEae(lastEae);
	}
