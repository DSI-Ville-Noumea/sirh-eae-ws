...
public interface IAlfrescoCMISService {
	 ...
	 * @param idAgent
	 *            Id de l agent
	 * @param eaeFinalizationDto
	 *            L entite EaeFinalizationDto
	 * @param eaeFinalisation
	 *            L entite EaeFinalization
	 * @param eae
	 *            L entite EAE
	 * @param returnDto
	 ...
	 */
	ReturnMessageDto uploadDocument(Integer idAgent, EaeFinalizationDto eaeFinalizationDto, EaeFinalisation eaeFinalisation, Eae eae,
			ReturnMessageDto returnDto);

	/**
	 * Upload de l EAE avec buffer pour soucis java heap space
	 * 
	 * @param idAgent
	 *            Id de l agent
	 * @param eaeFinalizationDto
	 ...
	 * @return ReturnMessageDto Le message de retour
	 */
	ReturnMessageDto uploadDocumentWithBuffer(Integer idAgent, InputStream inputStream, EaeFinalisation eaeFinalisation, Eae eae, String annee,
