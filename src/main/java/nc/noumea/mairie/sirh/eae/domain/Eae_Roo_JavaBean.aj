...
privileged aspect Eae_Roo_JavaBean {
    ...
    public Set<EaeFinalisation> Eae.getEaeFinalisations() {
        return this.eaeFinalisations;
    }
    
    public void Eae.setEaeFinalisations(Set<EaeFinalisation> eaeFinalisations) {
