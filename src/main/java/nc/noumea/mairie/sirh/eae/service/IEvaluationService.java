...
public interface IEvaluationService {
	...
	/**
	 * Returns the data for viewing/filling in the results of last year's EAE
	 * objectives
	 * 
	 * @param eae
	...
	/**
	 * Returns the data for viewing/filling in the auto evaluation part of an
	 * EAE
	 * 
	 * @param eae
	...
	void saveDateEvaluateurFromSirh(int idEae, BirtDto evaluateur) throws EaeServiceException;

	void saveDateEvalueFromSirh(int idEae, BirtDto evalue) throws EaeServiceException;
